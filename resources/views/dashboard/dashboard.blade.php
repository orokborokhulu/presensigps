  ...
  <div id="rekappresensi">
    ...
    <div class="row">
        <div class="col-3">
            <div class="card">
                <div class="card-body text-center"  style="padding: 16px 12px !important; line-height:0.5rem">
                    ...
                    <ion-icon name="finger-print-outline" style="font-size: 1.6rem;" class="text-primary mb-1"></ion-icon>
                    <br>
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-body text-center" style="padding: 16px 12px !important; line-height:0.5rem"> 
                    ...
                    <ion-icon name="footsteps-outline" style="font-size: 1.6rem;" class="text-success mb-1"></ion-icon>
                    <br>
        ...
        <div class="col-3">
            <div class="card">
                <div class="card-body text-center" style="padding: 16px 12px !important; line-height:0.5rem">
                    <span class="badge bg-danger" style="position:absolute; top:3px; right:10px; font-size:0.6rem; z-index:999" >{{$rekappresensi->jmlcuti}}</span>
                    <ion-icon name="storefront-outline" style="font-size: 1.6rem;" class="text-danger mb-1"></ion-icon>
                    <br>
        ...
        <div class="card historicard mb-1" style="border: 1px solid rgb(155, 4, 185)">
            <div class="card-body">
                <div class="historicontent">
                    <div class="iconpresensi">
                        <ion-icon name="footsteps-outline" style="font-size: 48px;" class="text-info"></ion-icon>
                    </div>
                    <div class="datapresensi">
