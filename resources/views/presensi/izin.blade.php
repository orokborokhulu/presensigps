...
<style>
    ...
    .datapresensi{
        ...
        .card{
            border: 1px solid rgb(37, 47, 244)
        }
            ...
            <div class="card-body">
                <div class="historicontent">
                    <div class="iconpresensi">
                        @if ($d->status == "i")
                        <ion-icon name="walk-outline" style="font-size: 48px; color:rgb(16, 5, 113)" ></ion-icon>
                        @elseif($d->status == "s")
                        <ion-icon name="medkit-outline" style="font-size: 48px; color:rgb(151, 11, 11)" ></ion-icon>
                        @elseif($d->status == "c")
                        <ion-icon name="storefront-outline" style="font-size: 48px; color:rgb(4, 169, 48)" ></ion-icon>
                        @endif
            ...
            <li>
                <div class="item">
                    <div class="in">
                        ...
                        @if ($d -> status_approved == 0)
                        <span class="badge bg-warning">Tunggu ACC</span>
                        @elseif($d->status_approved == 1)
                        <span class="badge bg-success">Disetujui</span>
                        @elseif($d->status_approved == 2)
                        <span class="badge bg-danger">DiTolak</span>
...
<div class="fab-button animate bottom-right dropdown" style="margin-bottom:70px">
    ...
    <div class="dropdown-menu">
            ...
            <ion-icon name="walk-outline" role="img" class="md-hydrated" aria-label="image-outline"></ion-icon>
            <p>Izin Absen</p>
            </a>

            <a  class="dropdown-item bg-primary" href="/izinsakit">
            <ion-icon name="medkit-outline" role="img" class="md-hydrated" aria-label="image-outline"></ion-icon>
            <p>Sakit</p>
            </a>

            <a  class="dropdown-item bg-primary" href="/izincuti">
            <ion-icon name="storefront-outline" role="img" class="md-hydrated" aria-label="image-outline"></ion-icon>
            <p>Cuti</p>
            </a>
    </div>
</div>
    ...
    $(function(){
        $(".card_izin").click(function(e){
            ...
            if(status_approved == 1){
                Swal.fire({
                    title: 'Oops!',
                    text: 'Data Disetujui, tidak dapat di Ubah',
                    icon: 'warning',
                })
            }else{
