    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" maxlength="10"  id="kode_libur"  name="kode_libur" class="form-control" value="{{ $harilibur->kode_libur }}" placeholder="Kode Libur " disabled>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" maxlength="10"  id="tanggal_libur" value="{{ $harilibur->tanggal_libur }}" name="tanggal_libur" class="form-control" placeholder="Tanggal Libur " autocomplete="off">
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" maxlength="50"  id="keterangan" value="{{ $harilibur->keterangan }}" name="keterangan" class="form-control" placeholder="Keterangan" autocomplete="off" >
            </div>
        </div>
    </div>
